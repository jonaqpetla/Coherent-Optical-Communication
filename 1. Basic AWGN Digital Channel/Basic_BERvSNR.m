...
for bits_per_symbol = [2 4 6]
    ...
    % experimental
    % figure;
    loglog(SNR_dB, BER, 'o', 'linewidth', 1.2);
    hold on;
    ...
    loglog(SNR_dB_smoother, BER_theoretical, '-', 'linewidth', 1.2);
end
xlabel("SNR (dB)");
ylabel("BER");
xticks([0, 5, 10, 15, 25]);
...
legend(["QPSK Simulation", "QPSK Theoretical", "16-QAM Simulation", "16-QAM Theoretical", "64-QAM Simulation", "64-QAM Theoretical"]);
set(gca, 'fontsize', 14);